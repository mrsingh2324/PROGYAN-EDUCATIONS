...
import ICON from '../../assets/icon.png'; // Import the icon correctly
...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="container mx-auto px-2"> {/* Added container here */}
        <div
          className={`${
        ...
        >
          <div className="flex items-center gap-4">
            ...
            />
            <div className="text-xl items-center flex gap-2 text-Teal uppercase tracking-wide font-bold">
              <span className="w-[15%]">
